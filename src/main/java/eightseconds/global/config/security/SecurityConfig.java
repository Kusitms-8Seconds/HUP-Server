...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/email/send/activate-user").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/email/send/reset-password").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/email/verify/activate-user").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/email/verify/reset-password").permitAll()
