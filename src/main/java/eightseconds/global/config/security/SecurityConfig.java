...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .antMatchers(HttpMethod.POST, "/api/v1/email/send/activate").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/email/send/reset").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/email/activate-user").permitAll()
                .antMatchers(HttpMethod.POST, "/api/v1/email/reset-password").permitAll()
