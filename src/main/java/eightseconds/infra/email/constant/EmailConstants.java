...
public class EmailConstants {
    ...
    public enum EEmailServiceImpl{
        ...
        eSendMessage3("<br>"),
        eSendMessage41("<p>아래 코드를 회원가입 창으로 돌아가 입력해주세요<p>"),
        eSendMessage42("<p>아래 코드를 비밀번호 재설정 창으로 돌아가 입력해주세요<p>"),
        eSendMessage5("<br>"),
        eSendMessage6("<p>감사합니다!<p>"),
        eSendMessage7("<br>"),
        eSendMessage8("<div align='center' style='border:1px solid black; font-family:verdana';>"),
        eSendMessage91("<h3 style='color:blue;'>회원가입 인증 코드입니다.</h3>"),
        eSendMessage92("<h3 style='color:blue;'>비밀번호 재설정 인증 코드입니다.</h3>"),
